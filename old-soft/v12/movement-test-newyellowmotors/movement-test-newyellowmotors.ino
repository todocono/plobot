...
const int MX_POWER = 100;

const int MN_POWER = 70;
...
//  TCCR2B = (TCCR1A & 0b00000000) | 0x04;
  ...
  PID myPID(&Input, &Output, &Setpoint, 12 / scale_factor, 5.5/ scale_factor, 4.5/ scale_factor, DIRECT); //Kp Ki  Kd
