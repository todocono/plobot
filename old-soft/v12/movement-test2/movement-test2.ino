...
void turn(int degs)
{
  ...
  //PID myPID(&Input, &Output, &Setpoint, 0.11, 0.1, 0.1, P_ON_M, DIRECT); //Kp Ki  Kd
  PID myPID(&Input, &Output, &Setpoint, 3000 / scale_factor, 40000 / scale_factor, 3.5 / scale_factor, P_ON_E, DIRECT);
