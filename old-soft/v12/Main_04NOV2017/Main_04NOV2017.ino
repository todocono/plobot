...
void setup() {
  ...
  addBitlashFunction("beep", (bitlash_function) beepSound);
//  addBitlashFunction("gyro", (bitlash_function) gyroscope);
...
//////////
// ultraSound: function handler for Bitlash card() function
/////////
...
///////////
//// gyro: function handler for Bitlash card() function
///////////
//numvar gyro(void) {
//  init_sense();
//  Serial.print("gyro answer: ");
//  Serial.println(sense_gyro());
//  //do something else
//  // myservos[slot].write(getarg(2));
//  return 0;
//}
...
///////////
//// tone: function handler for Bitlash card() function
///////////
numvar beepSound(void) {
  init_sound();
  Serial.println("beep! ");
